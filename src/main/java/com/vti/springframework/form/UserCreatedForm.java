...
public class UserCreatedForm {
    ...
    @Length(max =50, message = "User name has max 50 character")
    private String name;

    @NotBlank(message = "Username must not be blank")
    @Length(max =50, message = "Username has max 50 character")
    private String username;

    @NotBlank(message = "User email must not be blank")
    @Length(max =50, message = "User email  has max 50 character")
    ...
    @NotBlank(message = "User name muss=t not be blank")
    @Length(max =50, message = "User name has max 50 character")
